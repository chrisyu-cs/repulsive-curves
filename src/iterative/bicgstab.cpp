...
namespace LWS {
    ...
    std::vector<double> BiCGStab::A_pk;
    std::vector<double> BiCGStab::s_k;
    std::vector<double> BiCGStab::A_sk;

    /*
    void BiCGStab::Solve(BlockClusterTree *A, std::vector<double> &x, std::vector<double> &b) {
        A_pk.resize(x.size());
        s_k.resize(x.size());
        A_sk.resize(x.size());
        ...
        std::cout << "BiCGStab finished in " << k << " iterations" << std::endl;
    }

    bool BiCGStab::Iteration(BlockClusterTree *A, std::vector<double> &x_k,
